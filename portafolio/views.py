...
def Complete_task(request, task_id):
    task = Task.objects.filter(user=request.user, datecompleted__isnull=False).order_by('-datecompleted').get(pk=task_id)
    return render(request, 'tasks.html', {'task': task, 'tipopagina': 'Tareas Completadas'})
